...
/*
  ...
  |
 */
Route::group(['middleware' => ['web','auth'], 'namespace' => "Mage2\Contact\Controllers"], function () {

    Route::resource('/contact','ContactController');
    Route::get('/contact-data',['as' => 'contact.datatables.data' , 'uses' => 'ContactController@anyData']);
