...
use Mage2\Setup\Requests\ProjectStatusReqest;
...
class ProjectStatusController extends Controller {
     ...
     *
     * @param  \Mage2\Setup\Requests\ProjectStatusReqest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(ProjectStatusReqest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProjectStatusReqest $request, $id) {
        $projectStatus = ProjectStatus::findorfail($id);
