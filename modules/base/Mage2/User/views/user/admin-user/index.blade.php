        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped table-responsive ">
                ...
                <tr>
                    ...
                    <td>
                        @can("hasPermission",[\Mage2\User\Models\AdminUser::class,"setup.admin-user.edit"])
                        <a title="Admin User Edit" href="{{ route('setup.admin-user.edit', $adminUser) }}">Edit</a>
                        @else
                    ...
                    <td>
                        @can("hasPermission",[\Mage2\User\Models\AdminUser::class,"setup.admin-user.destroy"])
                        {!! Form::open(['method' => 'delete', 'action' => route('setup.admin-user.destroy', $adminUser)]) !!}
